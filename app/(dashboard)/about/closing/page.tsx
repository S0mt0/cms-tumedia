...
export default async function ClosingPage() { const initial = await getSection(); return <CmsEditorPageShell eyebrow="About page" title="Closing section" description="Industry focus, manifesto, and final contact invitation." breadcrumbs={[{ label: "Overview", href: "/" }, { label: "About", href: "/about" }, { label: "Closing" }]} previewHref={`${process.env.FRONTEND_BASE_URL ?? "http://localhost:3001"}/about`}><AboutEditor section="closing" initial={initial} title="Closing content" description="Edit industry focus, manifesto, and final calls to action." mediaPreviewBaseUrl={process.env.FRONTEND_BASE_URL ?? "http://localhost:3001"} /></CmsEditorPageShell>; }
