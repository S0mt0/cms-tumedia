...
export default async function GlobalCapabilityPage() { const initial = await getSection(); return <CmsEditorPageShell eyebrow="About page" title="Global capability" description="The locations and editorial images that demonstrate global reach." breadcrumbs={[{ label: "Overview", href: "/" }, { label: "About", href: "/about" }, { label: "Global capability" }]} previewHref={`${process.env.FRONTEND_BASE_URL ?? "http://localhost:3001"}/about`}><AboutEditor section="globalCapability" initial={initial} title="Global capability" description="Add, remove, edit, reorder and illustrate capability locations." mediaPreviewBaseUrl={process.env.FRONTEND_BASE_URL ?? "http://localhost:3001"} /></CmsEditorPageShell>; }
