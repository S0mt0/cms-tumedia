...
export default async function StoryPage() { const initial = await getSection(); return <CmsEditorPageShell eyebrow="About page" title="Our story" description="The story and principles presented on the public About page." breadcrumbs={[{ label: "Overview", href: "/" }, { label: "About", href: "/about" }, { label: "Our story" }]} previewHref={`${process.env.FRONTEND_BASE_URL ?? "http://localhost:3001"}/about`}><AboutSectionEditor section="story" initial={initial} title="Story content" description="Edit and reorder the story paragraphs and principle cards." mediaPreviewBaseUrl={process.env.FRONTEND_BASE_URL ?? "http://localhost:3001"} /></CmsEditorPageShell>; }
