import type { MarqueeIconKey } from "@/lib/constants/marquee-icons";
...
export type LandingSections = {
  ...
  positioning: { title: string; description: string; cta: CtaContent; stats: { id: string; value: string; label: string; order: number }[]; marqueeItems: { id: string; label: string; iconKey: MarqueeIconKey; order: number }[] };
  ...
  creatorFlowCta: { eyebrow: string; title: string; description: string; cta: CtaContent; media: MediaRef; mediaCaption: string };
  ...
  videoShowcase: { eyebrow: string; title: string; description: string; cta: CtaContent; youtubeUrl: string; videoTitle: string };
  whyTuMedia: { eyebrow: string; title: string; description: string; media: MediaRef; items: { id: string; text: string; order: number }[] };
  blogPreview: { eyebrow: string; title: string; cta: CtaContent; featuredCount: number };
  faq: { eyebrow: string; title: string; description: string; items: { id: string; question: string; answer: string; order: number }[] };
  finalCta: { eyebrow: string; title: string; description: string; primaryCta: CtaContent; reassurance: string };
};
